...
import { color, typography, breakpoint, shadeColor } from './shared';
...
const ButtonWrapper = styled.button`
  ...
  ${props => props.primary && css`
    ...
    svg path { fill: ${color.lightest}; }
      &:hover { background: ${shadeColor(color.primary, 7)};}
  ...
  ${props => props.secondary && css`
    ...
    color: ${color.lightest};
    svg path { fill: ${color.lightest}; }
      &:hover { background: ${shadeColor(color.secondary, 7)}; }
      &:active { box-shadow: rgba(0,0,0,.1) 0 0 0 3em inset; }
	`}
  ...
  ${props => props.tertiary && css`
    ...
    svg path { fill: ${color.darkest}; }
      &:hover { background: ${shadeColor(color.tertiary, 7)}; }
      &:active { box-shadow: rgba(0,0,0,.1) 0 0 0 3em inset; }
	`}
  ...
  ${props => props.inverse && css`
    ...
    &:active {
      color: ${shadeColor(color.primary, 7)};
    }
	`}
`;
