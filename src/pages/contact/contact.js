...
import ContactGoogleMap from '../../components/contact-google-map/index';
  ...
  return (
    <Contact>
      <div className="contenidos_contacto_texto">
        <p>
          <span className="contenidos_contacto_texto_titulo">Santa</span>
          <br />
          <br />
          ...
          28016 - Madrid<br />
          <br />
          Tf: <a href="tel:+34 91 353 39 54">+34 91 353 39 54</a>
          <br />
          <br />
          <a href="mailto:info@santacc.es">info@santacc.es</a>
        </p>
